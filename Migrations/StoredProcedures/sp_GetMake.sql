USE [vega]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetMake]    Script Date: 2017/05/28 8:26:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[sp_GetMake] 
AS
BEGIN
  ...
  DECLARE 
	@thisProc NVARCHAR(256) = N'dbo.sp_GetMake', --used for error messages
  ...
  BEGIN TRY
    ...
    SET @errmsg = N'[sp_GetMake] - Failed to get the makes.';

	SELECT 
		[Id]
		,[Name]
	FROM [vega].[dbo].[tb_CarMake]
