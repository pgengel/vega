USE [vega]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetPhoto]    Script Date: 2017/05/28 8:27:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[sp_GetPhoto] 
AS
BEGIN
  ...
  DECLARE 
	  @thisProc NVARCHAR(256) = N'dbo.sp_GetPhoto', --used for error messages
  ...
  BEGIN TRY
    ...
    SET @errmsg = N'[sp_GetPhoto]-Failed to return the list of photos';

	SELECT 
	   [Id]
      ,[FileName]
      ,[VehicleId]
	FROM [vega].[dbo].[tb_Photo]
