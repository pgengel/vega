...
namespace vega.Controllers
{
    ...
    public class VehicleController : Controller
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<VehicleResource>> GetVehicles(VehicleQeuryResource filterResource)
        {
            var filter = mapper.Map<VehicleQeuryResource, VehicleQuery>(filterResource);
